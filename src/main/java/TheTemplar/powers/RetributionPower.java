...
public class RetributionPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = TemplarMod.makeID(RetributionPower.class.getSimpleName());
    ...
    public RetributionPower(final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new RetributionPower(amount);
    }
}
